        ...
        <div class="flex justify-between items-center py-4">
          <div class="flex items-center space-x-4">
            <div class="flex items-center space-x-2">
              ...
              <h1 class="text-xl font-bold text-gray-900">咖啡厅点单</h1>
            </div>
          </div>
          <div class="flex items-center space-x-4">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
          <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-6 border-b border-gray-200">
              <h2 class="text-lg font-semibold text-gray-900">饮品菜单</h2>
              <p class="mt-1 text-sm text-gray-500">选择您喜欢的饮品</p>
            </div>
                ...
                >
                  ...
                  <div class="p-4">
                    ...
                    <div class="mb-4" v-if="drink.hasTemperature">
                      <p class="text-sm font-medium text-gray-700 mb-2">温度选择</p>
                      <div class="flex space-x-2">
                        <button
                          v-for="temp in ['热饮', '温饮', '冰饮']"
                          :key="temp"
        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 sticky top-4">
            <div class="p-6 border-b border-gray-200">
              <h2 class="text-lg font-semibold text-gray-900">购物车</h2>
              <p class="mt-1 text-sm text-gray-500">{{ cartItems.length }} 个商品</p>
            </div>
                  ...
                  <div class="flex">
                    ...
                    <div class="ml-3">
                      <p class="text-sm text-red-600">
                        余额不足，还需要 ¥{{ (totalAmount - currentUser.remainingQuota).toFixed(2) }}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div v-else class="p-6 text-center">
              ...
              <p class="mt-2 text-sm text-gray-500">购物车是空的</p>
              <p class="text-xs text-gray-400 mt-1">选择您喜欢的饮品开始点单吧！</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
          <div>
            ...
            <div class="mt-3 text-center sm:mt-5">
              <h3 class="text-lg leading-6 font-medium text-gray-900">订单提交成功！</h3>
              <div class="mt-2">
                <p class="text-sm text-gray-500">
                  您的订单已提交，订单号为 #{{ lastOrderId }}
                </p>
              </div>
            </div>
          </div>
